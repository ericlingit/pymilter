...
class MimeTestCase(unittest.TestCase):
    ...
    def testDefang(self, vname="virus1", part=1, fname="LOVE-LETTER-FOR-YOU.TXT.vbs"):
        try:
    ...
    def testDefang6(self, vname="virus6", fname="FAX20.exe"):
        ...
        txt2 = msg.get_payload()
        self.assertTrue(txt2 == mime.virus_msg % (fname, hostname, None), txt2)
    ...
    def testDefang7(self, vname="honey", fname="story[1].scr"):
        ...
        if txt3 != "":
            self.assertTrue(
                txt3.rstrip() + "\n"
                == mime.virus_msg % ("story[1].asp", hostname, None),
                txt3,
            )
