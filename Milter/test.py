...
class TestBase(object):
    ...
    def log(self, *msg):
        for i in msg:
            print(i, file=self.logfp, end=None)
    ...
    def chgfrom(self, sender, params=None):
        ...
        self.log(f"chgfrom: sender={sender}")
    ...
    def chgheader(self, field, idx, value):
        ...
        self.log(f"chgheader: {field}[{idx}]={value}")
        if value == "":
            del self._msg[field]
        else:
    ...
    def addheader(self, field, value, idx=-1):
        ...
        self.log(f"addheader: {field}={value}")
        self._msg[field] = value
        self._headerschanged = True
