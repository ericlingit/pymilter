    ...
    def check(self, ip, sender, recipient, timeinc=0):
        ...
        ip=? and sender=? and recipient=?""",
          ...
          where ip=? and sender=? and recipient=?""",
                ...
                cnt = r["cnt"] + 1
                cur.execute(
                    """update greylist set lastseen=?,cnt=?
          where ip=? and sender=? and recipient=?""",
